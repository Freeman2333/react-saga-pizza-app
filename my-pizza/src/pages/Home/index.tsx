...
import { loadRecommendationRequest } from '../../store/ducks/recommendation/action';
...
const Home = () => {
  ...
  const { pizza, loading } = useSelector(
    (state: ApplicationState) => state.recommendations
  );
  useEffect(() => {
  ...
  return (
    <Container>
      ...
      <h4>
        Selecione sua massa: <Steps>0 / 4</Steps>
      </h4>
